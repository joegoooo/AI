...
def main():
    ...
    optimizer = optim.Adam(base_params, lr=1e-4, weight_decay=0.0001)
    ...
    for epoch in range(EPOCHS): #epoch
        logger.info(f'Epoch: {epoch}, Max_acc: {max_acc}')
    ...
    logger.info("Start extracting features from dataset")
